	...
	function pizzaro_get_header_version() {
		...
		switch( $template_file ) {
			case 'template-homepage-v1.php':
				$header_version = apply_filters( 'pizzaro_home_v1_header_version', 'v1' );
				break;
			case 'template-homepage-v2.php':
				$header_version = apply_filters( 'pizzaro_home_v2_header_version', 'v2' );
				break;
			case 'template-homepage-v3.php':
				$header_version = apply_filters( 'pizzaro_home_v3_header_version', 'v3' );
				break;
			case 'template-homepage-v4.php':
				$header_version = apply_filters( 'pizzaro_home_v4_header_version', 'v3' );
				break;
			case 'template-homepage-v5.php':
				$header_version = apply_filters( 'pizzaro_home_v5_header_version', 'v4' );
				break;
			case 'template-homepage-v6.php':
				$header_version = apply_filters( 'pizzaro_home_v6_header_version', 'v5' );
				break;
			case 'template-homepage-v7.php':
				$header_version = apply_filters( 'pizzaro_home_v7_header_version', 'v4' );
				break;
			default:
