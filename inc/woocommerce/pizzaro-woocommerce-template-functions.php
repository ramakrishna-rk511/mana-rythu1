	...
	function pizzaro_cart_link() {
		?>
			<a class="cart-contents" href="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'pizzaro' ); ?>">
				<span class="amount"><span class="price-label"><?php esc_attr_e( 'Your Cart:', 'pizzaro' ); ?></span><?php echo wp_kses_data( WC()->cart->get_cart_subtotal() ); ?></span> <span class="count"><?php echo wp_kses_data( WC()->cart->get_cart_contents_count() );?></span>
			</a>
		<?php
	}
}
